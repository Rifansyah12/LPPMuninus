...
export function CardHome({ backgroundColor = "#1C532A", img = "/research.png" }) {
  return (
    <div className="w-[358px] flex shadow-md rounded-md">
      <div
        className={`w-[179px] h-[179px] bg-[${backgroundColor}] flex justify-center items-center shadow-md rounded-l-md`}
      >
